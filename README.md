...
============================
For BofA credit cards, there is a different mapping file and script, called mapping_cc.py and csvofx_cc.py,included in this repository. The input file is called stmt_cc.csv but the output file is still the same, bofa.ofx. 
